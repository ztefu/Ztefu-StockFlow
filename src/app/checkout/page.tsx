...
export default async function CheckoutPage({
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-white dark:bg-gray-900 selection:bg-primary/30">
      ...
      {/* Left Section - Form */}
      <div className="w-full lg:w-1/3 flex items-center justify-center p-4 sm:p-8 lg:p-12 relative bg-gray-50 lg:bg-white dark:bg-gray-900 z-10 lg:border-r lg:border-gray-100 lg:dark:border-gray-800">
