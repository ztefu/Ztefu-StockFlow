      ...
      <div className="w-full lg:w-1/3 flex items-center justify-center p-4 sm:p-8 lg:p-12 relative bg-gray-50 lg:bg-white dark:bg-gray-900 z-10 border-r border-gray-100 dark:border-gray-800">
        ...
        <div className="w-full max-w-sm bg-white dark:bg-dark-surface lg:bg-transparent lg:dark:bg-transparent lg:shadow-none lg:border-none rounded-2xl shadow-xl border border-white/20 dark:border-gray-800/50 p-6 sm:p-8 z-10 relative">
          ...
          <div className="bg-gray-100/80 dark:bg-gray-800/80 p-1 rounded-xl flex items-center mb-8">
            ...
            <div className="flex-1 text-center py-2 text-sm font-semibold rounded-lg bg-white dark:bg-gray-700 shadow-sm text-gray-900 dark:text-white transition-all cursor-default">
              Inscription
            </div>
          </div>
      ...
      <div className="hidden lg:flex lg:w-2/3 relative bg-gray-50/50 dark:bg-gray-900 flex-col justify-center items-center overflow-hidden">
        ...
        <div className="w-full max-w-2xl p-8 relative z-10 flex flex-col items-center">
          <div className="mb-10 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4">L'aventure commence ici.</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">Rejoignez les milliers d'entrepreneurs qui ont transformé leur gestion.</p>
          </div>
          ...
          <div className="absolute -top-4 right-1/3 bg-white dark:bg-gray-800 p-2 rounded-full shadow-lg border border-gray-100 dark:border-gray-700 animate-float-pulse z-20">
            <div className="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-500 p-1.5 rounded-full">
              <Star size={18} />
            </div>
          </div>
        </div>
