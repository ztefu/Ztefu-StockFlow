...
import { LineChart, Box, BellRing, PackageCheck, TrendingUp } from 'lucide-react'
...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-white dark:bg-gray-900 selection:bg-primary/30">
      ...
      <div className="w-full lg:w-1/3 flex items-center justify-center p-4 sm:p-8 lg:p-12 relative bg-gray-50 lg:bg-white dark:bg-gray-900 z-10 border-r border-gray-100 dark:border-gray-800">
        ...
        <div className="w-full max-w-sm bg-white dark:bg-dark-surface lg:bg-transparent lg:dark:bg-transparent lg:shadow-none lg:border-none rounded-2xl shadow-xl border border-white/20 dark:border-gray-800/50 p-6 sm:p-8 z-10 relative">
          ...
          {error && (
            <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl text-sm text-red-600 dark:text-red-400 flex items-center justify-center text-center">
              {message || "Une erreur est survenue lors de l'authentification."}
            </div>
          )}
          {!error && message && (
            <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl text-sm text-green-600 dark:text-green-400 flex items-center justify-center text-center">
              {message}
            </div>
          )}
      ...
      <div className="hidden lg:flex lg:w-2/3 relative bg-gray-50/50 dark:bg-gray-900 flex-col justify-center items-center overflow-hidden">
        ...
        <div className="w-full max-w-2xl p-8 relative z-10 flex flex-col items-center">
          <div className="mb-10 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4">Gérez votre stock comme un pro.</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">La plateforme tout-en-un pour suivre et optimiser votre inventaire en temps réel.</p>
          </div>
          ...
          <div className="absolute top-1/4 -left-4 bg-white dark:bg-gray-800 p-3 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 floating-icon-delayed z-20">
            <LineChart className="text-primary" size={24} />
          </div>
          
          <div className="absolute bottom-1/4 -right-4 bg-white dark:bg-gray-800 p-3 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 floating-icon z-20">
            <Box className="text-green-500" size={24} />
          </div>

          <div className="absolute -top-6 right-1/4 bg-white dark:bg-gray-800 p-2 rounded-full shadow-lg border border-gray-100 dark:border-gray-700 animate-float-pulse z-20">
